...
{{fig:plate:character-chr-16,plate:monster-ash-drake,plate:tool-hammer,plate:tile-warehouse|frieze}}

### R-08 · The granary: no spoilage, or a row up the strip

{{fig:plate:tile-granary|margin|The granary: its card says no spoilage, the strip says one row up}}
...
{{fig:plate:tool-axe,plate:tool-saw,plate:tool-scythe|Three tools, each with a build cost the third rule halves}}

{{fig:flow:blacksmith|third|The blacksmith's flow, printing the Repair Tool job in its own older words}}
...
{{fig:plate:item-lantern|margin|The lantern, wear printed on its strip and denied in its text}}
...
{{fig:plate:tool-pick|margin|A tool wears by the job, whoever swings it}}
...
{{fig:plate:character-chr-05|margin|Ruk of the Red Road, promised a combat die the battle rule never rolls}}

{{fig:card:SPL-02,card:SPL-04,card:MOD-04,card:BLD-45,card:EVT-10,card:EVT-18|Six cards still printed in the language of hits and combat dice}}
...
{{fig:plate:character-chr-09|margin|A hero on the road eats like any figure, and rolls no extra die}}
...
{{fig:plate:character-chr-08|margin|Old Mother Keswick, whose card sets the smallest purse; the card's purse is the purse}}
...
{{fig:plate:tile-market|margin|The merchant's stock, sold at any settlement of town rank or better}}
