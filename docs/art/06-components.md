...
- **Back:** a drawn plate of its own — the same building on the same ground with the work not
  ...
  page. Labelled **SITE**, or **SOWN** for a field. It was generated once — a lathe, the word
  and a row of terrain marks — and a picture says what the marks were reaching for and says it
  better.
