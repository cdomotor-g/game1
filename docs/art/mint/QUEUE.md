...
> **Note.** cards: 1 of 203 plates are under the 945 px long side this line needs — a 80 mm card window at 300 dpi — smallest is `SPL-14` at 600 px. They render fine on screen and they are the limit on how large the artefact can be printed.
