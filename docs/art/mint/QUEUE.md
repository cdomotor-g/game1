...
> **Note.** cards: every plate clears the 866 px floor (a square card window of 55 x 55 mm printed at 2 x card size, 200 dpi), and 58 of 58 are under the 1299 px this line would want for print — smallest is `TAL-01` at 1254 px. That is an aspiration, not a fault.
...
**149 of 205 minted.** 0 waiting on a brief, 54 waiting on art, 2 waiting on frame.
