...
> **Note.** cards: every plate clears the 945 px floor (a 80 mm card window at 300 dpi), and 85 of 156 are under the 1890 px this line would want for print — smallest is `TAL-01` at 1254 px. That is an aspiration, not a fault.
...
**81 of 156 minted.** 0 waiting on a brief, 71 waiting on art, 4 waiting on frame.
