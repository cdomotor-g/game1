...
**cards 50/71 · maps 1/1**

> **Note.** cards: every plate clears the 945 px floor (a 80 mm card window at 300 dpi), and 50 of 71 are under the 1890 px this line would want for print — smallest is `TAL-01` at 1254 px. That is an aspiration, not a fault.
...
**50 of 71 minted.** 0 waiting on a brief, 21 waiting on art, 0 waiting on frame.

### 1 · WRITE — the designer

Nothing waiting.

### 2 · DRAW — the artist — 21 cards
