...
29 tiles complete: `hut`, `timber-house`, `brick-house`, `manor`, `lumber-camp`, `quarry`, `clay-pit`, `sand-pit`, `mine`, `oil-derrick`, `well`, `farm`, `pasture`, `orchard`, `vineyard`, `apiary`, `dock`, `sawmill`, `charcoal-kiln`, `smelter`, `steelworks`, `brewery`, `winery`, `warehouse`, `granary`, `market`, `trading-house`, `town-hall`, `barracks`.
