...
- **54 tiles, double-sided** — 49 buildings and 5 sown fields. Face is the building; back is
  **SITE** (or **SOWN**), laid that way up while the work is being paid for, carrying the
  terrain marks for what ground it may stand on.
...
| TALLY | | MEMORY | | PRICE |
| --- | --- | --- | --- | --- |
| `0 1 2 3 4` | | `−3 −2 −1 0 +1 +2 +3` | | `×0.5 ×0.75 ×1 ×1.25 ×1.5 ×2` |
