...
window.GAME_DATA = {
  ...
  "items": {
    ...
    "classes": [
      ...
      },
      {
        "id": "provision",
        "name": "Provision",
        "summary": "Food carried for the road. Its W track is the days left in it: knock a rung down for every figure it feeds at the end of a round - see rules.json upkeep.food. At 0 the pack is empty and the card is discarded."
      },
      {
        "id": "potion",
        "name": "Potion",
    ...
    "items": [
      ...
      },
      {
        ...
        "wear": 6,
        "uses": 3,
        "story": "A whole hide turned inside out, stitched at three seams and stopped with a turned bung on a thong. It tastes of the animal for a month and of the road ever after.",
        "effects": [
          "Holds 3 draughts. Filled in an hour at a well, a marsh or fresh water, with no barrel (recipes.json draw-water).",
          "Spend a draught to Forage on desert or tundra, which recipes.json forage otherwise forbids.",
          "Wears 1 each time it is drunk dry."
        ]
      },
      {
        "id": "map",
        ...
        "massKg": 0.25,
        "wear": 6,
        "story": "Four sheets sewn into a folding case, copied off a merchant house's road book. The coast is careful, the interior optimistic, and three of its towns have changed hands.",
        "effects": [
          "+1 hex on a day leg between two settlements printed on it (travel.json legs.day).",
          "Once a round, learn the price band of one commodity family in any settlement it covers, without going there.",
          "Wears 1 for every round it is unfolded."
        ]
      },
      {
        "id": "compass",
        ...
        "massKg": 0.25,
        "wear": 8,
        "story": "A lodestone needle on a pin under glass, in a copper case that shuts with a click you can hear across a camp. It says not where you are, but which way you have been walking.",
        "effects": [
          "A night leg under a lantern runs at full day speed rather than half (travel.json night.lantern).",
          "Its extra discovery roll is made at the ordinary monster band (rules.json movement.legs.nightRisk).",
          "Wears 1 for every night leg it steers."
        ]
      },
      {
        "id": "rations-3-day",
        "name": "Three-Day Rations",
        "class": "provision",
        "cardCode": "ITM-13",
        "slot": "carried",
        "madeAt": "granary",
        ...
        "wear": 3,
        "uses": 3,
        "story": "Hard bread, salt beef and a twist of salt, packed by somebody who counts for a living. Three days is what a party carries between two towns it knows the road between.",
        "effects": [
          "Three days' food. Feed one figure at the end of a round and knock the W track down a rung (rules.json upkeep.food).",
          "The uses ARE the wear: an empty sack is a spent sack.",
          "Dried and salted, so it does not perish."
        ]
      },
      {
        "id": "rations-10-day",
        "name": "Ten-Day Rations",
        "class": "provision",
        "cardCode": "ITM-14",
        "slot": "carried",
        "madeAt": "granary",
        ...
        "wear": 10,
        "uses": 10,
        "story": "The crossing pack: ten days in a bound sack with the seams doubled, sold at every granary within a week of the desert and nowhere else at all.",
        "effects": [
          "Ten days' food: one rung of the W track for every figure fed at the end of a round (rules.json upkeep.food).",
          "The uses ARE the wear: an empty sack is a spent sack.",
          "Eight kilograms - most of what strength 3 can shoulder (rules.json carrying)."
        ]
      },
      {
        "id": "arrows-10",
        ...
        "wear": 5,
        "uses": 5,
        "story": "A sheaf of ten, bound at the neck with a twist of cord. An archer looses a dozen in a fight and walks the field afterwards for most of them; what this card counts is the two that split on a shield or go into the grass.",
        "effects": [
          "Shot from a quiver, and no use to anybody without one.",
          "Each battle with a bow or a crossbow spends 1, from the sheaf before the quiver.",
          "The uses ARE the wear: an empty sheaf is a spent sheaf."
        ]
      },
      {
        "id": "arrows-20",
        ...
        "wear": 10,
        "uses": 10,
        "story": "Two sheaves in a war-bag, which is what a village fletcher sells to somebody who has said where the road goes. The same arrows, twice as long between fletchers, and still the cheapest line on any archer's bill.",
        "effects": [
          "Shot from a quiver, and no use to anybody without one.",
          "Each battle with a bow or a crossbow spends 1, from the bag before the quiver.",
          "The uses ARE the wear: an empty bag is a spent bag."
        ]
      },
      {
        "id": "potion-vigour",
  ...
  "components": {
    ...
    "$deckKeys": {
      ...
      "plateFormat": "the page the artist draws - see docs/art/09-framing-and-composition.md. It must be one of the formats data/mint.json lines.cards.draw.sizeByFormat declares, because that is where the page's pixel shape comes from and the WINDOW block in every brief is the deck's card window over exactly that shape. The events and quests decks said \"landscape scene\" for as long as they were held back, which is a description rather than a format: no entry, no page, no WINDOW - so the two decks would have been turned on into briefs that could never learn what their own crop keeps. They are 3:2 landscape now, the format the vehicles deck already draws on and the one their own card window is nearest.\n\nThe requirement is on a deck that COMMISSIONS, which is every minting deck and was every deck when this was written. A deck with `plateKind` borrowed commissions nothing: it has no brief, so there is no WINDOW block to be missing, and it has no page of its own to name because it shows plates drawn to somebody else's. BUILDINGS is the one, and the sentence it carries instead is what the mint queue prints in its deferred table, where a reader wants the reason rather than an enum. Turn such a deck on to minting and it needs a real format like any other - which is the check, and it is the same one sentence that fails it.",
    ...
    "lines": [
      {
        ...
        "plate": {
          ...
          "minLongSide": {
            ...
            "dpi": 200,
            "wantDpi": 300,
            "$note": "DERIVED, not typed. tools/lib/mint.mjs works this out from components.stock.card, the way tools/build-board.mjs works out a track column from the paper: a number somebody types is a number that goes stale the day the thing it describes changes size.\n\nThe rule, in words: A CARD PLATE MUST PRINT CLEANLY AT TWICE THE CARD'S SIZE. `printScale` is that 2 - the rulebook shows a card's picture blown up to a half-page section, twice the card, and that is the largest anything a card plate feeds is ever printed. `dpi` is the FLOOR at that scale: 200 dpi at twice the card, which is 400 on the card itself, and the least a colour illustration prints without visible softness. `wantDpi` is the aspiration, 300 at twice the card. A plate under the floor is REFUSED at the shipping step (tools/ship-art.mjs, and the landing workflow that calls it); a plate between the two is accepted and reported once, as a note, by the queue.\n\nThe size is measured where the pixels are spent - through the card's picture window - and the window can never be bigger than the card's SAFE AREA, because the frame, the stat strip and the story rail take theirs first. So the floor is the safe area, cut to the shape of the page this deck draws on (`draw.sizeByFormat`), at printScale x dpi. A square page is measured against a square cut from the safe area, not against its long side: asking a square plate for the pixels of a portrait window would be asking for pixels no window has room to spend. tools/validate-framing.mjs then reports the REAL density of every landed plate through its deck's built window, which is tighter still.\n\nThis line used to say a flat 4000 px, which is the MAP's number - an A1 sheet wants it - inherited by a card that prints at 94 mm on its long side and never did. Then it said 300 dpi on the card, which nothing stated in the briefs agreed with, so an artist read 945 px in the queue, 2000 px in the brief and produced 1254, and rightly called the contract ambiguous. There is one figure now, it is written into every brief's marker by tools/build-prompts.mjs, and a pixel count typed into a brief by hand fails --check."
          },
  ...
  "artstyle": {
    ...
    "registers": [
      ...
      },
      {
        "id": "spells",
        "name": "Spells",
        "plate": "a plate from an illustrated book of workings",
        "palette": null,
        "$noPalette": "A spell is an arcane subject, and an arcane subject's colour rule IS its composition - one violet laid out of register - so the house colour paragraph is skipped rather than contradicted. Same bargain the talismans register already takes.",
        "composition": [
          "ONE ordinary thing at the moment the working takes hold, drawn from close to - a hearth, a sail, a cracked lintel, a stretch of water, a hand's-breadth of ground - on a short ground line, at the scale of a naturalist's study. Everything in the picture is a real made or grown thing, observed: the timber has grain, the iron has hammer marks, the rope is laid up out of strands. The working is not a light and not a shape; it is what the ordinary thing is DOING that it could not do on its own.",
          "Its ONLY unusual quality: a flat violet spot colour (#6B4C7D) printed out of register - offset about a millimetre from the black line, bleeding past the edge like a misprint on a cheap press - and laid ONLY across the part the working touches, never across the whole page. The black line itself is perfectly normal. No glow, no sparkle, no light source, no particles, no rays, no runes, no gesturing caster."
        ],
        "closing": "Paper is warm oatmeal, never white. Ink is warm near-black, never pure black. Strictly no gradients, no drop shadows, no soft shading, no lens effects. No text, no letters, no border rule.",
        "negative": [
          "magic particles",
          "glowing runes",
          "arcane circle",
      ...
      },
      {
        "id": "events",
        "name": "Events",
        "plate": "a plate from an illustrated chronicle of the year",
        "palette": "warm ochre, rust red, dusty grey-green, cold slate blue",
        "composition": [
          "A wide landscape plate of ONE thing that has already happened, drawn at middle distance from a standing person's eye height, with a low horizon in the bottom third and the ground running out to both edges of the page. It is told through OBJECTS AND CONSEQUENCE, never through a face: an overturned cart and grain in the wheel ruts, not a frightened carter; a shuttered stall and a swept-clean trestle, not a haggling crowd. Any people are small, distant, incidental and busy with the clearing up - nobody is the subject and nobody is looking out of the page.",
          "One clear silhouette dominates and reads at a glance across a table; everything else is the ground it happened on. The tone is dry, plain and after-the-fact - the weather report, not the disaster painting."
        ],
        "closing": "Strictly no gradients, no glow, no drop shadows, no soft airbrushed shading, no lens effects. No text, no letters, no signage, no border rule.",
        "negative": [
          "close-up portrait",
          "face",
          "facing the viewer",
      ...
      },
      {
        "id": "quests",
        "name": "Quests",
        "plate": "a plate from an illustrated traveller's account",
        "palette": "warm ochre, rust red, dusty grey-green, cold slate blue",
        "composition": [
          "A wide landscape plate of ONE place with something UNFINISHED in it, drawn at middle distance from the road - the approach to it, never the arrival - with a low horizon in the bottom third and the ground running out to both edges of the page. Where an event plate is the aftermath, this is the threshold: the errand is still to be run and the picture is the invitation. The unfinished thing is a plain object or a plain mark on the ground, drawn precisely - a hopper standing empty, a lantern hook with no lantern on it, a coppice rooted up, a track leading into the fen - and it sits where the eye lands.",
          "Any people are small, distant and at their own work; nobody is the subject, nobody is heroic and nobody is looking out of the page. Ordinary daylight and ordinary weather. The tone is a note in a travelling ledger - here is the place, here is what is wanted - never an adventure poster."
        ],
  ...
  "art": {
    ...
    "renders": {
      ...
      "character-chr-09": {
        "file": "art/renders/character-chr-09.png",
        "width": 1055,
        "height": 1491,
        "subject": [
          0.1,
      ...
      "character-chr-10": {
        "file": "art/renders/character-chr-10.png",
        "width": 1055,
        "height": 1491,
        "subject": [
          0.08,
      ...
      "character-chr-11": {
        "file": "art/renders/character-chr-11.png",
        "width": 1055,
        "height": 1491,
        "subject": [
          0.1,
      ...
      "character-chr-12": {
        "file": "art/renders/character-chr-12.png",
        "width": 1057,
        "height": 1488,
        "subject": [
          0.1,
      ...
      "character-chr-13": {
        "file": "art/renders/character-chr-13.png",
        "width": 1055,
        "height": 1491,
        "subject": [
          0.02,
      ...
      "character-chr-14": {
        "file": "art/renders/character-chr-14.png",
        "width": 1057,
        "height": 1488,
        "subject": [
          0.05,
      ...
      "character-chr-16": {
        "file": "art/renders/character-chr-16.png",
        "width": 1056,
        "height": 1489,
        "subject": [
          0,
      ...
      "character-chr-17": {
        "file": "art/renders/character-chr-17.png",
        "width": 1054,
        "height": 1492,
        "subject": [
          0,
      ...
      "character-chr-18": {
        "file": "art/renders/character-chr-18.png",
        "width": 1055,
        "height": 1491,
        "subject": [
          0,
      ...
      "character-chr-19": {
        "file": "art/renders/character-chr-19.png",
        "width": 1056,
        "height": 1489,
        "subject": [
          0.05,
      ...
      "character-chr-20": {
        "file": "art/renders/character-chr-20.png",
        "width": 1055,
        "height": 1491,
        "subject": [
          0.02,
      ...
      "character-chr-21": {
        "file": "art/renders/character-chr-21.png",
        "width": 1055,
        "height": 1491,
        "subject": [
          0.05,
      ...
      "character-chr-22": {
        "file": "art/renders/character-chr-22.png",
        "width": 1054,
        "height": 1492,
        "subject": [
          0.05,
      ...
      "event-earthquake": {
        "file": "art/renders/event-earthquake.png",
        "width": 1536,
        "height": 1024,
        "subject": [
          0.119,
      ...
      "event-impure-smelt": {
        "file": "art/renders/event-impure-smelt.png",
        "width": 1536,
        "height": 1024,
        "subject": [
          0.1025,
      ...
      "event-migrants": {
        "file": "art/renders/event-migrants.png",
        "width": 1536,
        "height": 1024,
        "subject": [
          0,
      ...
      "event-wildfire": {
        "file": "art/renders/event-wildfire.png",
        "width": 1536,
        "height": 1024,
        "subject": [
          0.124,
      ...
      "item-arrows-20": {
        "file": "art/renders/item-arrows-20.png",
        "width": 1254,
        "height": 1254,
        "subject": [
          0.055,
      ...
      "spell-stormcall": {
        "file": "art/renders/spell-stormcall.png",
        "width": 1254,
        "height": 1254,
        "subject": [
          0,
