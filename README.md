...
docs/          the published website AND the design documents — see Publishing
  ...
  book/              GENERATED printed book from rules/*.md, data/*.json and
                     design/*.md, via tools/build-book.mjs — Book I the rules, then
                     the reference tables, the illustrated catalogue, one annex per
                     campaign, the design notes; every section printable alone.
...
tools/
  ...
  build-book.mjs     docs/rules/*.md + data/*.json + docs/design/*.md → docs/book/,
...
book, generated by `tools/build-book.mjs` and committed. It is five things in one page,
